...
class Views @Inject() (
    ...
    val calculate_instalments_form_2: views.html.calculator.calculate_instalments_form_2,
    ...
    val amount_due:                   views.html.unauth.amount_due,
    val payment_plan_calculator:      views.html.unauth.payment_plan_calculator,
    val check_calculation:            views.html.unauth.check_calculation,
