...
object Taxpayer {
  implicit val format: Format[Taxpayer] = Json.format[Taxpayer]
}
...
object SelfAssessment {
  implicit val format: Format[SelfAssessment] = Json.format[SelfAssessment]
}
...
object CommunicationPreferences {
  implicit val format: Format[CommunicationPreferences] = Json.format[CommunicationPreferences]
}
...
object Debit {
  implicit val format: Format[Debit] = Json.format[Debit]
}
...
object CalculatorAmountDue {
  ...
  implicit val format: Format[CalculatorAmountsDue] = Json.format[CalculatorAmountsDue]
