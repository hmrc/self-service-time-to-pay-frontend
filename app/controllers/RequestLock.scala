...
class RequestLock @Inject() (reactiveMongoComponent: ReactiveMongoComponent)(
    implicit
    appConfig: AppConfig, ec: ExecutionContext) {

  def tryLock[T](lockName: String)(body: => Future[T])(implicit ec: ExecutionContext): Future[Option[T]] = {
