...
class DirectDebitErrorPageSpec extends ItSpec {
  ...
  "click continue" in {
    ...
    directDebitErrorPage.assertInitialPageIsDisplayed(English)
    directDebitErrorPage.clickOnWelshLink()
    directDebitErrorPage.assertInitialPageIsDisplayed(Welsh)
  }
}
