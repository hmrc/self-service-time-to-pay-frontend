...
import timetopaytaxpayer.cor.model.{CommunicationPreferences, Debit, Interest, Return, ReturnsAndDebits, SaUtr, SelfAssessmentDetails}
...
class CalculatorLogicSpec extends PlaySpec with TableDrivenPropertyChecks {
  ...
  val scenariosBasedAroundJanuaryDuedate = Table(
    ...
    //Customer 1
    (testStartDate, returnsAndDebits.copy(debits = List(makeDebit("BCD", "2016-04-05", 1000, "2017-01-31"),
                                                        makeDebit("POA1", "2016-04-05", 2000, "2017-01-31"),
                                                        makeDebit("POA2", "2016-04-05", 2000, "2017-01-31"))), 11),
    //Customer 2
    (testStartDate.withMonth(2).withDayOfMonth(14), returnsAndDebits.copy(debits = List(makeDebit("BCD", "2016-04-05", 1000, "2017-01-31"),
                                                                                        makeDebit("POA1", "2016-04-05", 3000, "2017-01-31", Some(40)),
                                                                                        makeDebit("POA2", "2016-04-05", 3000, "2017-07-31"))), 10),
    // Customer 4
    (testStartDate.withMonth(1).withDayOfMonth(10), returnsAndDebits.copy(debits = List(makeDebit("BCD", "2016-04-05", 1000, "2017-01-31"),
                                                                                        makeDebit("POA1", "2016-04-05", 3000, "2017-01-31", Some(40)),
  ...
  val scenariosBasedAroundJulyDuedate = Table(
    ("todayDate", "self assessment", "expected answer"),
    //Customer 9
    (testStartDate.withMonth(7).withDayOfMonth(1), returnsAndDebits.copy(debits = List(makeDebit("POA2", "2016-04-05", 5000, "2017-07-31"))), 5),
    //Customer 10
    (testStartDate.withMonth(8).withDayOfMonth(14), returnsAndDebits.copy(debits = List(makeDebit("POA2", "2016-04-05", 3000, "2017-07-31", Some(20)))), 4),
    //Customer 11
    (testStartDate.withMonth(7).withDayOfMonth(1), returnsAndDebits.copy(debits = List(makeDebit("POA2", "2016-04-05", 3000, "2017-07-31"),
                                                                                       makeDebit("Interest from previous arrangement", "2015-04-05", 28, "2016-01-31"))), 5),
    //Customer 13
    (testStartDate.withMonth(7).withDayOfMonth(1), returnsAndDebits.copy(debits = List(makeDebit("POA2", "2016-04-05", 3000, "2017-07-31"))), 5))

  val scenariosBasedAroundEarlyFilers = Table(
    ("todayDate", "self assessment", "expected answer"),
    //Customer 15
    (testStartDate.withMonth(7).withDayOfMonth(1), returnsAndDebits.copy(debits  = List(makeDebit("POA2", "2016-04-05", 5000, "2017-07-31")), returns = List(testReturn2016, testReturn2017)), 11),
    //Customer 16
    (testStartDate.withMonth(7).withDayOfMonth(1), returnsAndDebits.copy(debits  = List(makeDebit("POA2", "2016-04-05", 5000, "2017-07-31"),
    ...
    //Customer 19
    (testStartDate.withMonth(5).withDayOfMonth(1), returnsAndDebits.copy(debits  = List(makeDebit("BCD", "2017-04-05", 1000, "2018-01-31"),
  ...
  val scenariosBasedAroundLateFilers = Table(
    ...
    (testStartDate.withMonth(7).withDayOfMonth(1), returnsAndDebits.copy(debits  = List(makeDebit("BCD", "2017-04-05", 0, "2017-07-31"),
    ...
    (testStartDate.withMonth(4).withDayOfMonth(20), returnsAndDebits.copy(debits  = List(makeDebit("BCD", "2017-04-05", 0, "2017-07-31"),
    ...
    //Customer 22
    (testStartDate.withMonth(3).withDayOfMonth(20), returnsAndDebits.copy(debits  = List(makeDebit("Late payment penalty", "2016-04-05", 100, "2017-03-25")), returns = List(testReturn2016, testReturn2017)), 11),
    //Customer 24
    (testStartDate.withMonth(3).withDayOfMonth(20), returnsAndDebits.copy(debits  = List(makeDebit("POA2", "2016-04-05", 3000, "2017-07-31"),
                                                                                         makeDebit("Late payment penalty", "2016-04-05", 100, "2017-03-17")), returns = List(testReturn2016, testReturn2017)), 11),
    //Customer 25
    (testStartDate.withMonth(11).withDayOfMonth(20), returnsAndDebits.copy(debits  = List(makeDebit("Late payment penalty", "2016-04-05", 100, "2016-12-16"),
  ...
  val scenariosBasedCustom = Table(("todayDate", "self assessment", "expected answer"),
    (testStartDate.withMonth(12).withDayOfMonth(18), returnsAndDebits.copy(debits  = List(makeDebit("IN1", "2018-04-05", 30, "2018-01-31"),
