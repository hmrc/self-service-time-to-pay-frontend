...
class CalculatorLogicSpec extends PlaySpec with TableDrivenPropertyChecks {
  ...
  val scenariosBasedAroundJanuaryDuedate = Table(
    ...
    //Customer 1
    (testStartDate, sa.copy(debits = List(makeDebit("BCD", "2016-04-05", 1000, "2017-01-31"),
                                          makeDebit("POA1", "2016-04-05", 2000, "2017-01-31"),
                                          makeDebit("POA2", "2016-04-05", 2000, "2017-01-31"))), 11),
    //Customer 2
    (testStartDate.withMonth(2).withDayOfMonth(14), sa.copy(debits = List(makeDebit("BCD", "2016-04-05", 1000, "2017-01-31"),
                                                                          makeDebit("POA1", "2016-04-05", 3000, "2017-01-31", Some(40)),
                                                                          makeDebit("POA2", "2016-04-05", 3000, "2017-07-31"))), 10),
    // Customer 4
    (testStartDate.withMonth(1).withDayOfMonth(10), sa.copy(debits = List(makeDebit("BCD", "2016-04-05", 1000, "2017-01-31"),
                                                                          makeDebit("POA1", "2016-04-05", 3000, "2017-01-31", Some(40)),
  ...
  val scenariosBasedAroundJulyDuedate = Table(
    ("todayDate", "self assessment", "expected answer"),
    //Customer 9
    (testStartDate.withMonth(7).withDayOfMonth(1), sa.copy(debits = List(makeDebit("POA2", "2016-04-05", 5000, "2017-07-31"))), 5),
    //Customer 10
    (testStartDate.withMonth(8).withDayOfMonth(14), sa.copy(debits = List(makeDebit("POA2", "2016-04-05", 3000, "2017-07-31", Some(20)))), 4),
    //Customer 11
    (testStartDate.withMonth(7).withDayOfMonth(1), sa.copy(debits = List(makeDebit("POA2", "2016-04-05", 3000, "2017-07-31"),
                                                                         makeDebit("Interest from previous arrangement", "2015-04-05", 28, "2016-01-31"))), 5),
    //Customer 13
    (testStartDate.withMonth(7).withDayOfMonth(1), sa.copy(debits = List(makeDebit("POA2", "2016-04-05", 3000, "2017-07-31"))), 5))
