...
class CalculatorServiceSpecAlternate extends ItSpec {
  ...
  val interestCalculationScenarios = Table(
    ...
    ("1.f", Seq(debit(2000.00, "2017-01-31"), debit(2000.00, "2017-02-01")), date("2017-03-11"), date("2018-01-20"), date("2017-04-20"), 2500, 10, 4032.92, 32.92, 150.00, 182.92), ("2.a", Seq(debit(2000.00, "2017-03-31")), date("2017-03-11"), date("2018-01-20"), date("2017-04-20"), 0, 10, 2023.7, 23.7, 200.00, 223.7),
