...
class CalculatorServiceSpecAlternate extends ItSpec {
  ...
  val interestCalculationScenarios = Table(
    ...
    ("1.d", Seq(debit(2000.00, "2017-01-31")), date("2017-03-11"), date("2018-01-20"), date("2017-04-20"), 1000, 10, 2019.61, 19.61, 100.00, 119.61),
    ("1.e", Seq(debit(2000.00, "2017-01-31"), debit(1000.00, "2017-02-01")), date("2017-03-11"), date("2018-01-20"), date("2017-04-20"), 2000, 10, 3023.91, 23.91, 100.00, 123.91),
    ("1.f", Seq(debit(2000.00, "2017-01-31"), debit(2000.00, "2017-02-01")), date("2017-03-11"), date("2018-01-20"), date("2017-04-20"), 2500, 10, 4033.11, 33.11, 150.00, 183.11),
