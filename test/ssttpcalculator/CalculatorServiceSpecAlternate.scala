...
class CalculatorServiceSpecAlternate extends ItSpec {
  ...
  val interestCalculationScenarios = Table(
    ...
    ("1.d", Seq(debit(2000.00, "2017-01-31")), date("2017-03-11"), date("2018-01-20"), date("2017-04-20"), 1000, 10, 2019.46, 19.46, 100.00, 119.46),
    ("1.e", Seq(debit(2000.00, "2017-01-31"), debit(1000.00, "2017-02-01")), date("2017-03-11"), date("2018-01-20"), date("2017-04-20"), 2000, 10, 3023.6, 23.6, 100.00, 123.6),
    ("1.f", Seq(debit(2000.00, "2017-01-31"), debit(2000.00, "2017-02-01")), date("2017-03-11"), date("2018-01-20"), date("2017-04-20"), 2500, 10, 4032.73, 32.73, 150.00, 182.73),
