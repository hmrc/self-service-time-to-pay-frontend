...
//
//  val interestCalculationScenarios: TableFor11[String, Seq[TaxLiability], LocalDate, LocalDate, LocalDate, Int, Int, Double, Double, Double, Double] = Table(
...
//
//      val schedule: PaymentSchedule = calculatorService.schedule(regularInstalmentAmount, calculation, initialPayment).get
//
