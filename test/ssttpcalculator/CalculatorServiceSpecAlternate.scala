...
class CalculatorServiceSpecAlternate extends ItSpec {
  ...
  val interestCalculationScenarios = Table(
    ...
    ("1.a.i.c", Seq(debit(2000.00, "2017-01-31")), date("2017-03-11"), date("2018-01-20"), date("2017-04-20"), 0, 10, 2032.74, 32.74, 200.00, 232.74),
    ("1.a.ii.c", Seq(debit(2000.00, "2015-01-31")), date("2016-03-14"), date("2017-01-20"), date("2016-04-20"), 0, 10, 2095.61, 95.61, 200.00, 295.61),
    ("1.b.ii.c", Seq(debit(2000.00, "2016-01-31")), date("2017-03-11"), date("2018-01-20"), date("2017-04-20"), 0, 10, 2090.39, 90.39, 200.00, 290.39),
    ("1.d", Seq(debit(2000.00, "2017-01-31")), date("2017-03-11"), date("2018-01-20"), date("2017-04-20"), 1000, 10, 2019.54, 19.54, 100.00, 119.54),
    ("1.e", Seq(debit(2000.00, "2017-01-31"), debit(1000.00, "2017-02-01")), date("2017-03-11"), date("2018-01-20"), date("2017-04-20"), 2000, 10, 3023.68, 23.68, 100.00, 123.68),
    ("1.f", Seq(debit(2000.00, "2017-01-31"), debit(2000.00, "2017-02-01")), date("2017-03-11"), date("2018-01-20"), date("2017-04-20"), 2500, 10, 4032.85, 32.85, 150.00, 182.85),
    ("2.a", Seq(debit(2000.00, "2017-03-31")), date("2017-03-11"), date("2018-01-20"), date("2017-04-20"), 0, 10, 2023.85, 23.85, 200.00, 223.85),
    ("2.b", Seq(debit(2000.00, "2017-03-18")), date("2017-03-11"), date("2018-01-20"), date("2017-04-20"), 1000, 10, 2012.91, 12.91, 100.00, 112.91),
    ("2.c", Seq(debit(2000.00, "2017-03-18"), debit(2000.00, "2017-03-19")), date("2017-03-11"), date("2018-01-20"), date("2017-04-20"), 2000, 10, 4025.66, 25.66, 200.00, 225.66),
    ("2.d", Seq(debit(2000.00, "2017-03-18"), debit(2000.00, "2017-03-19")), date("2017-03-11"), date("2018-01-20"), date("2017-04-20"), 2500, 10, 4019.25, 19.25, 150.00, 169.25),
    ("2.e", Seq(debit(2000.00, "2017-03-31")), date("2017-03-11"), date("2018-01-20"), date("2017-04-20"), 1000, 10, 2011.93, 11.93, 100.00, 111.93)
  )
