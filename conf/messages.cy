#common
ssttp.common.title = Trefnu cynllun talu
...
ssttp.common.charge-code.DET = Penderfyniad refeniw
...
ssttp.common.charge-code.LFI2 = Cosb am gyflwyno 12 mis yn hwyr
ssttp.common.charge-code.LFP1 = Cosb i bartneriaeth am gyflwyno 6 mis yn hwyr
ssttp.common.charge-code.LFP2 = Cosb i bartneriaeth am gyflwyno 12 mis yn hwyr
ssttp.common.charge-code.LPI = Llog ar daliadau hwyr {0}
ssttp.common.charge-code.LPP1 = Cosb am dalu 30 diwrnod yn hwyr
ssttp.common.charge-code.LPP2 = Cosb am dalu 6 mis yn hwyr
ssttp.common.charge-code.LPP3 = Cosb am dalu 12 mis yn hwyr
ssttp.common.charge-code.MRMP = Cosb
ssttp.common.charge-code.NUP = Swm sydd heb ei gynnwys yn y Cod Treth mwyach
ssttp.common.charge-code.OREP = Atodiad ad-daliad
ssttp.common.charge-code.PF1 = Cosb gyntaf ar gyfer Ffurflen Dreth hwyr
ssttp.common.charge-code.PF2 = Ail gosb ar gyfer Ffurflen Dreth hwyr
ssttp.common.charge-code.PL1 = Cosb am gyflwyno’n hwyr am y flwyddyn a ddaeth i ben {0}
ssttp.common.charge-code.PP1 = Cosb gyntaf ar gyfer Ffurflen Dreth Partneriaeth hwyr
ssttp.common.charge-code.PP2 = Ail gosb ar gyfer Ffurflen Dreth Partneriaeth hwyr
ssttp.common.charge-code.PPL1 = Cosb i bartneriaeth am gyflwyno’n hwyr
ssttp.common.charge-code.RAM = Diwygiad i’r Ffurflen Dreth
ssttp.common.charge-code.REP = Ad-daliad
ssttp.common.charge-code.REV = Diwygiad ymholiad
ssttp.common.charge-code.SUP = Swm sydd heb ei gynnwys yn y cod treth mwyach
...
ssttp.sidebar.help-and-advice.feedback.submit = Anfonwch eich adborth atom


#sign in sidebar
ssttp.sidebar.sign-in.title = Mewngofnodi
ssttp.sidebar.sign-in.intro = Os ydych wedi cyflwyno’ch Ffurflen Dreth Hunanasesiad, ac mae’ch cyfrif treth yn gyfredol, gallwch osgoi’r cam hwn drwy fewngofnodi.
ssttp.sidebar.sign-in.link = Mewngofnodi gan ddefnyddio Porth y Llywodraeth
ssttp.sidebar.call_for_assistance.link = Ffonio am gymorth

#having problems sidebar
ssttp.sidebar.having_problems.title = Oes problem?
...
ssttp.landing.before-you-start.list.1 = mae arnoch £10,000 neu lai
...
ssttp.calculator.form.payment_summary.up-front-payment.hint = Wedi’i gymryd ymhen 3 i 5 diwrnod
...
ssttp.calculator.form.payment_today_question.required.title = Nid ydych wedi dewis opsiwn
...
ssttp.calculator.form.duration.months.less-than = Rhaid i’r nifer o fisoedd fod yn llai na 12
...
ssttp.call-us.opening-times.l1 = Dydd Llun i ddydd Gwener: 08:30 – 17:00
...
ssttp.direct-debit.unauthorized.intro.p1.link = lenwi fersiwn bapur o’r ffurflen mandad.
...
ssttp.arrangement.instalment-summary.up-front-payment = Taliad ymlaen llaw
ssttp.arrangement.instalment-summary.up-front-payment.hint = Wedi’i gymryd ymhen 3 i 5 diwrnod
...
ssttp.direct-debit-assistance.initial-payment.hint = wedi’i gymryd hyd at {0} o ddiwrnodau o heddiw ymlaen
ssttp.direct-debit-assistance.monthly-instalments = rhandaliadau misol o:
ssttp.direct-debit-assistance.interest-added-to-final = wedi’i ychwanegu at y taliad terfynol
...
ssttp.direct-debit.form.sortCode.hint = Enghraifft: 000000
ssttp.direct-debit.form.error.accountName.required = Nodwch enw cyfrif
ssttp.direct-debit.form.error.accountName.not-text = Mae enw’r cyfrif yn cynnwys cymeriadau nad ydynt yn ddilys
ssttp.direct-debit.form.error.accountName.check = Gwiriwch fod enw eich cyfrif yn gywir
...
ssttp.direct-debit.guarantee.list.2 = Os oes unrhyw newidiadau i swm, dyddiad neu amlder eich Debyd Uniongyrchol, bydd Cyllid a Thollau EM yn eich hysbysu 10 diwrnod gwaith cyn i’ch cyfrif gael ei ddebydu neu fel y cytunwyd fel arall. Os gwnewch gais i Gyllid a Thollau EM i gasglu taliad, rhoddir cadarnhad o’r swm a’r dyddiad i chi ar adeg y cais.
ssttp.direct-debit.guarantee.list.3 = Os gwneir camgymeriad gan Gyllid a Thollau EM neu’ch banc neu gymdeithas adeiladu wrth dalu Debyd Uniongyrchol, mae gennych hawl i ad-daliad llawn a di-oed o’r swm a dalwyd o’ch banc neu’ch cymdeithas adeiladu.
ssttp.direct-debit.guarantee.list.4 = Os cewch ad-daliad nad oes gennych hawl iddo, rhaid i chi ei dalu’n ôl pan fydd Cyllid a Thollau EM yn gofyn i chi wneud hynny.
ssttp.direct-debit.guarantee.list.5 = Gallwch ganslo Debyd Uniongyrchol ar unrhyw adeg drwy gysylltu â’ch banc neu gymdeithas adeiladu. Efallai y bydd angen cadarnhad ysgrifenedig. Rhowch wybod i ninnau hefyd.
ssttp.direct-debit.title = Amserlen taliadau’r Debyd Uniongyrchol
ssttp.direct-debit.account-name = Enw’r cyfrif
ssttp.direct-debit.account-number = Rhif y cyfrif
ssttp.direct-debit.sort-code = Cod didoli
ssttp.direct-debit.change = Newid
ssttp.direct-debit.payment-frequency = Amlder y taliadau
ssttp.direct-debit.monthly = Misol
...
ssttp.arrangement.direct-debit.confirmation.bank-instruction.phone.2 = Ffôn testun: 0300 200 3319
...
ssttp.arrangement.direct-debit.confirmation.bank-instruction.please-check = Gwiriwch yr wybodaeth hon yn ofalus cyn cadarnhau’r taliad
ssttp.arrangement.direct-debit.assistance.title = Ffoniwch am gymorth gyda Debydau Uniongyrchol
...
#accessiblitystatement
 accessibility-statement.title = Datganiad Hygyrchedd
 accessibility-statement-h1 = Datganiad hygyrchedd ar gyfer Y gwasanaeth Taliadau Ar-lein yw
 accessibility-statement-p1 = Mae’r datganiad hygyrchedd hwn yn esbonio pa mor hygyrch yw’r gwasanaeth hwn, beth i’w wneud os ydych yn cael anhawster i’w ddefnyddio, a sut i roi gwybod am broblemau hygyrchedd gyda’r gwasanaeth.
 accessibility-statement-p2a = Mae’r gwasanaeth hwn yn rhan o wefan ehangach GOV.UK. Mae
 accessibility-statement-a1 = datganiad hygyrchedd
 accessibility-statement-p2b = ar wahân ar gyfer prif wefan GOV.UK.
 accessibility-statement-p3 = Mae’r dudalen hon ond yn cynnwys gwybodaeth am wasanaeth Y gwasanaeth Taliadau Ar-lein yw, sydd ar gael yn www.tax.service.gov.uk/pay
 accessibility-statement-h2 = Defnyddio’r gwasanaeth hwn
 accessibility-statement-p4 = Y gwasanaeth Taliadau Ar-lein yw dull digidol CThEM o dalu gan ddefnyddio cerdyn. Mae’n caniatáu i ddefnyddwyr dalu eu rhwymedigaethau treth ar gyfer cyfundrefnau sy’n cynnwys, ond heb fod yn gyfyngedig i, TAW, Hunanasesiad, COTAX ac EPAYE. Mae’n derbyn cardiau debyd busnes a phersonol yn ogystal â chardiau credyd busnes. Mae’n cynnwys iFrame wedi’i wirio. Rhoddir hwn gan Barclaycard. Nid yw CThEM yn gyfrifol am ei hygyrchedd.
 accessibility-statement-p5 = Mae’r gwasanaeth hwn wedi’i redeg gan Gyllid a Thollau EM (CThEM). Rydym am i gymaint o bobl â phosibl allu defnyddio’r gwasanaeth hwn. Mae hyn yn golygu y dylech allu:
 ...
 accessibility-statement-l1-item5 = •	Gwrando ar y gwasanaeth drwy ddefnyddio darllenydd sgrin (gan gynnwys y fersiynau diweddaraf o JAWS, NVDA a VoiceOver)
 ...
 accessibility-statement-p7a = Mae gan
 accessibility-statement-a2 = AbilityNet
 accessibility-statement-p7b = gyngor ar wneud eich dyfais yn haws i’w defnyddio os oes gennych anabledd.
 accessibility-statement-h3 = Pa mor hygyrch yw’r gwasanaeth hwn
 accessibility-statement-p8 = Mae’r gwasanaeth hwn yn cydymffurfio’n rhannol â
 accessibility-statement-a3 = safon ‘AA’ Canllawiau Hygyrchedd Cynnwys y We, fersiwn 2.1.
 accessibility-statement-p9 = Efallai y bydd rhai pobl yn ei chael hi’n anodd defnyddio rhannau o’r gwasanaeth hwn:
 accessibility-statement-l2-item1 = •	Ar un adeg, rydym yn dangos iFrame taliad, sy’n cael ei reoli gan Barclaycard. Efallai y bydd defnyddwyr â nam ar eu golwg yn ei chael yn anodd llywio’r gwasanaeth, hyd yn oed gyda thechnoleg gynorthwyol.
 accessibility-statement-l2-item2 = •	Mae rhai negeseuon gwall yn y gwasanaeth hwn efallai’n na fydd yn ddigon disgrifiadol i rai defnyddwyr â nam ar eu golwg – fodd bynnag maent yn gydnaws ag offer technoleg gynorthwyol gyffredin.
 accessibility-statement-l2-item3 = •	Ar ryw adeg, rydym yn dangos tudalennau lle nad yw’r fformatio ar gyfer elfennau unigol ar y sgrin yn gwbl addas ar gyfer technolegau darllen sgrin, ac felly’n arwain at dudalen sy’n anodd ei llywio o ganlyniad i wybodaeth anghyflawn. Fodd bynnag, bydd defnyddio darllenydd sgrin i ddarllen y dudalen gyfan yn uchel yn rhoi’r holl wybodaeth sydd ei hangen i lywio’r dudalen yn hyderus.
 accessibility-statement-h4 =Rhoi gwybod am broblemau hygyrchedd gyda’r gwasanaeth hwn
 accessibility-statement-p10 = Rydym bob amser yn ceisio gwella hygyrchedd y gwasanaeth hwn. Os byddwch yn dod o hyd i unrhyw broblemau nad ydynt wedi’u rhestru ar y dudalen hon, neu os ydych o’r farn nad ydym yn bodloni gofynion hygyrchedd, rhowch wybod am y
 accessibility-statement-a4 = broblem hygyrchedd (yn agor ffenestr neu dab newydd)
 accessibility-statement-h5 = Beth i’w wneud os nad ydych yn hapus â sut rydym yn ateb eich cwyn
 accessibility-statement-p11a = Mae’r Comisiwn Cydraddoldeb a Hawliau Dynol (EHRC) yn gyfrifol am orfodi Rheoliadau Hygyrchedd Cyrff Sector Cyhoeddus (Gwefannau a Chymwysiadau Symudol) (Rhif 2) 2018 (y ‘rheoliadau hygyrchedd’). Os nad ydych yn hapus â sut rydym yn ateb eich cwyn,
 accessibility-statement-a5 = cysylltwch â’r Gwasanaeth Cynghori a Chymorth Cydraddoldeb (EASS)
 accessibility-statement-p11b = , neu’r
 accessibility-statement-a6 = Equality Commission for Northern Ireland (ECNI)
 accessibility-statement-p11c = os ydych yn byw yng Ngogledd Iwerddon.
 ...
 accessibility-statement-p16b = , oherwydd y diffyg cydymffurfio a restrir isod.
 accessibility-statement-h8 = Cynnwys nad yw’n hygyrch
 accessibility-statement-p17 = Nid yw’r cynnwys a restrir isod yn hygyrch oherwydd y rhesymau canlynol.
 accessibility-statement-h9 = Diffyg cydymffurfio â rheoliadau hygyrchedd
 accessibility-statement-p18 = Rydym yn defnyddio iFrame Barclaycard i gymryd manylion y cerdyn a’r taliadau ar gyfer y tâl neu’r dreth y mae defnyddwyr yn eu talu. Nid yw’r iFrame hwn yn rhoi cyfle i ddefnyddwyr gadarnhau eu manylion ar ôl iddynt eu nodi. Nid yw hyn yn bodloni maen prawf llwyddiant 3.3.6 Canllawiau Hygyrchedd Cynnwys y We, fersiwn 2.1.
 accessibility-statement-p19 = Rydym yn bwriadu ychwanegu llwybr hygyrch i’ch galluogi i gadarnhau’ch manylion ar gyfer taliadau cerdyn erbyn Gorffennaf 2020.
 accessibility-statement-p20 = Rydym yn defnyddio teitlau ar ein tudalennau gwe er mwyn disgrifio pwnc neu bwrpas y dudalen y mae’r defnyddiwr yn edrych arni ar hyn o bryd. Mewn rhai achosion, nid yw’r teitlau ar y tabiau a’r prif deitlau yn gyson. Mae hyn yn golygu nad yw’r gwasanaeth yn bodloni maen prawf llwyddiant 2.4.6 Canllawiau Hygyrchedd Cynnwys y We, fersiwn 2.1.
 accessibility-statement-p21 = Rydym yn bwriadu ychwanegu teitlau cyson ar gyfer yr holl dudalennau yn y gwasanaeth erbyn mis Mawrth 2020.
 accessibility-statement-p22 = Rydym yn defnyddio penawdau ac is-benawdau tudalennau i ddisgrifio pwnc neu bwrpas meysydd ar dudalen we. Ar rai tudalennau, mae yna benawdau lefel 3 sy’n benawdau lefel 2 mewn gwirionedd. Mae hyn yn achosi i bobl sy’n defnyddio darllenwyr sgrin gael gwybodaeth aneglur ynghylch y dudalen. Mae hyn yn golygu nad yw’r gwasanaeth yn bodloni maen prawf llwyddiant 2.4.10 Canllawiau Hygyrchedd Cynnwys y We.
 accessibility-statement-p23 = Rydym yn bwriadu trwsio trefn penawdau ac is-benawdau i fodloni’r maen prawf llwyddiant erbyn mis Mawrth 2020.
 accessibility-statement-p24 = Rydym yn defnyddio botymau radio i gyflwyno opsiynau i ddefnyddwyr ar ein tudalennau gwe. Mae’r rhain yn cael eu grwpio gyda’i gilydd i alluogi llywio haws i ddefnyddwyr sy’n defnyddio bysellfwrdd yn unig. Mewn rhai achosion, mae’r grwpiau hyn yn colli eu labeli, sy’n atal rhai meddalwedd darllen sgrin rhag adrodd y label. Mae hyn yn golygu nad yw’r gwasanaeth yn bodloni maen prawf llwyddiant 2.4.6 Canllawiau Hygyrchedd Cynnwys y We.
 accessibility-statement-p25 = Rydym yn bwriadu ychwanegu’r labeli a’r setiau maes cywir at bob un o’n botymau radio erbyn mis Mawrth 2020.
 accessibility-statement-h10 = Sut gwnaethom brofi’r gwasanaeth hwn
 accessibility-statement-p26 = Cafodd y gwasanaeth ei brofi ddiwethaf ar 25/09/19 a gwiriwyd ei fod yn cydymffurfio â safon ‘AA’ Canllawiau Hygyrchedd Cynnwys y We, fersiwn 2.1.
 ...
 accessibility-statement-p28 = Paratowyd y dudalen hon ar 09/10/2019. Cafodd ei diweddaru ddiwethaf ar 09/10/2019.